...
#### 20260205（v2.25）
- 修复关闭状态的issue编辑后会被抓取的BUG https://github.com/Meekdai/Gmeek/issues/170
- 修改首页h1标签为div
- 修复评论按钮多次点击导致的BUG https://github.com/Meekdai/Gmeek/issues/198
- 修复witdh拼写错误和页脚添加空格 https://github.com/Meekdai/Gmeek/pull/303
