...
def bundle_pinned_issues_section():
    ...
    pinned_label = ghiblog.get_label('Top')
...
def bundle_list_by_labels_section():
    ...
    wordcloud_image_url="meekdai.com"
...
def bundle_cover_image_section() -> str:
    global ghiblog
    cover_label = ghiblog.get_label('Home Picture')
...
def bundle_projects_section() -> str:
    ...
    project_label = ghiblog.get_label('Open Source')
